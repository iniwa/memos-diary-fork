...
export const memoService = {
   ...
   *
   * Diary Mode: the stored content is split into a body and its boundary tag
   * lines, so `tags` can feed the dedicated TagSection.
   */
  fromMemo(memo: Memo): Pick<EditorState, "content" | "tags" | "metadata" | "timestamps"> {
